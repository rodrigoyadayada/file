...
% Forked from : Sourabh Bajaj https://github.com/sb2nov/resume
% License : MIT
%------------------------
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://sourabhbajaj.com/}{\Large Rodrigo Alves Vieira}} & Email : \href{mailto:rodrigoalvesvieira@protonmail.com.com}{rodrigoalvesvieira@protonmail.com.com}\\
  \href{https://github.com/rodrigoalvesvieira/}{https://github.com/rodrigoalvesvieira} & Mobile : +55-98259-9865 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.Sc Computer Science - incomplete}{December 2012 -- June 2016}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {BitJa}{Recife, Brazil}
      {CTO \& Co-founder}{Jun 2017 - Dec 2018}
      \resumeItemListStart
